import{_ as s,o as n,c as a,Q as l,a1 as p,a2 as o,a3 as e}from"./chunks/framework.be85cde1.js";const C=JSON.parse('{"title":"Building an Electron Project Quickly with Vite and React","description":"","frontmatter":{},"headers":[],"relativePath":"tutorials/create-vite-electron-service.md","filePath":"tutorials/create-vite-electron-service.md"}'),t={name:"tutorials/create-vite-electron-service.md"},c=l('<h1 id="building-an-electron-project-quickly-with-vite-and-react" tabindex="-1">Building an Electron Project Quickly with Vite and React <a class="header-anchor" href="#building-an-electron-project-quickly-with-vite-and-react" aria-label="Permalink to &quot;Building an Electron Project Quickly with Vite and React&quot;">​</a></h1><h2 id="create-a-vite-react-project" tabindex="-1">Create a Vite+React project <a class="header-anchor" href="#create-a-vite-react-project" aria-label="Permalink to &quot;Create a Vite+React project&quot;">​</a></h2><p>Use the official Vite guide to create a vite+react project.</p><p><code>yarn create vite</code></p><p>Select <code>React</code>, choose <code>Typescript + SWC</code>.</p><p><img src="'+p+'" alt="alt Create"></p><h2 id="modify-the-project-structure" tabindex="-1">Modify the project structure <a class="header-anchor" href="#modify-the-project-structure" aria-label="Permalink to &quot;Modify the project structure&quot;">​</a></h2><p>Under the <code>src</code> directory, create <code>main</code>, <code>render</code>, <code>preload</code>, and <code>work</code> directories, then move all the original content under src to the render directory, and change the import of script in <code>index.html</code> to <code>&lt;script type=&quot;module&quot; src=&quot;/src/render/main.tsx&quot;&gt;&lt;/script&gt;</code></p><p><img src="'+o+`" alt="alt Create"></p><ul><li><code>main</code> is the main process related code directory</li><li><code>render</code> is the renderer process related code directory</li><li><code>preload</code> is the preload script service code directory</li><li><code>work</code> is the worker process related code directory</li></ul><p>This outlines the core engineering directories of an electron project.</p><p>Then we need to create an <code>index.ts</code> entry file under render, preload, and work respectively, to facilitate Vite to start these services later.</p><h2 id="add-configuration-file" tabindex="-1">Add configuration file <a class="header-anchor" href="#add-configuration-file" aria-label="Permalink to &quot;Add configuration file&quot;">​</a></h2><p>Create a configuration file at the root</p><ul><li><code>ep.config.ts</code></li></ul><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { builtinModules } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&quot;module&quot;</span><span style="color:#E1E4E8;">;</span></span>
