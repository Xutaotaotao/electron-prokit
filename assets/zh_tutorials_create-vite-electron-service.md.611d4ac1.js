import{_ as s,o as n,c as a,Q as l,a1 as p,a2 as o,a3 as e}from"./chunks/framework.be85cde1.js";const C=JSON.parse('{"title":"用 Vite+React 快速构建一个 Electron 项目","description":"","frontmatter":{},"headers":[],"relativePath":"zh/tutorials/create-vite-electron-service.md","filePath":"zh/tutorials/create-vite-electron-service.md"}'),t={name:"zh/tutorials/create-vite-electron-service.md"},c=l('<h1 id="用-vite-react-快速构建一个-electron-项目" tabindex="-1">用 Vite+React 快速构建一个 Electron 项目 <a class="header-anchor" href="#用-vite-react-快速构建一个-electron-项目" aria-label="Permalink to &quot;用 Vite+React 快速构建一个 Electron 项目&quot;">​</a></h1><h2 id="创建一个-vite-react-的项目" tabindex="-1">创建一个 Vite+React 的项目 <a class="header-anchor" href="#创建一个-vite-react-的项目" aria-label="Permalink to &quot;创建一个 Vite+React 的项目&quot;">​</a></h2><p>用 Vite 官方的指引创建一个 vite+react 的项目。</p><p><code>yarn create vite</code></p><p>选择 React，选择 Typescript + SWC。</p><p><img src="'+p+'" alt="alt 创建"></p><h2 id="修改项目结构" tabindex="-1">修改项目结构 <a class="header-anchor" href="#修改项目结构" aria-label="Permalink to &quot;修改项目结构&quot;">​</a></h2><p>我们在<code>src</code>目录下创建<code>main</code>、<code>render</code>、<code>preload</code>、<code>work</code>四个目录，然后将 src 下原有的所有内容移动到<code>render</code>目录下，然后改变<code>index.html</code>中<code>script</code>的引入<code>&lt;script type=&quot;module&quot; src=&quot;/src/render/main.tsx&quot;&gt;&lt;/script&gt;</code></p><p><img src="'+o+`" alt="alt 创建"></p><ul><li><code>main</code> 是主进程相关的工程代码目录</li><li><code>render</code> 是渲染进程相关的工程代码目录</li><li><code>preload</code> 是预加载相关脚本服务的工程代码目录</li><li><code>work</code> 是任务进程相关的工程代码目录</li></ul><p>这样就把一个 electron 的核心工程目录梳理划分出来了。</p><p>然后我们需要在<code>render</code>、<code>preload</code>、<code>work</code>下分别创建一个<code>index.ts</code>入口文件，方便后续用 Vite 去启动这些服务。</p><h2 id="添加工程配置文件" tabindex="-1">添加工程配置文件 <a class="header-anchor" href="#添加工程配置文件" aria-label="Permalink to &quot;添加工程配置文件&quot;">​</a></h2><p>这一步我们在根目录下创建一个<code>ep.config.ts</code>文件。</p><ul><li><code>ep.config.ts</code></li></ul><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { builtinModules } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&quot;module&quot;</span><span style="color:#E1E4E8;">;</span></span>
...
<span class="line"><span style="color:#24292E;">});</span></span></code></pre></div><h2 id="集成自定义项目启动脚本" tabindex="-1">集成自定义项目启动脚本 <a class="header-anchor" href="#集成自定义项目启动脚本" aria-label="Permalink to &quot;集成自定义项目启动脚本&quot;">​</a></h2><p>有了 Vite 配置文件之后，我们就可以自定义开发脚本来启动本地的 electron 项目了。</p><p>在根目录下创建<code>scripts</code>目录，添加<code>dev.ts</code>文件。</p><p>安装@electron-prokit/create-service\`</p><p><code>yarn add @electron-prokit/create-service -D</code></p><p>-<code>scripts/dev.ts</code></p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> createViteElectronService </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;@electron-prokit/create-service&#39;</span><span style="color:#E1E4E8;">;</span></span>
